...
module Execution =
    ...
    /// <summary>
    /// The subtree holding the admitted leaves and the groups on their paths.
    /// </summary>
    ...
    /// <summary>The leaves of the tree, in pre-order.</summary>
    ...
    /// <summary>
    /// Publishes every group of the tree, a parent before its children. A group carries no
    /// state, so it is a group node rather than a test.
    /// </summary>
    let publishGroups
        (bus: IMessageBus)
